...
class _PastPapersPageState extends State<PastPapersPage> {
  ...
  deletePastPaperFirebaseFunction(
    ...
    try {
        ...
        try {
          ...
          firabase_storage.Reference ref =
              firabase_storage.FirebaseStorage.instance.ref().child(
                  'pastpapers_question_audios/${uuid.v4()}${DateTime.now().microsecondsSinceEpoch.toString()}');
      ...
      if (selectedQuestionImageUploaded == true) {
        try {
          ...
          firabase_storage.Reference ref =
              firabase_storage.FirebaseStorage.instance.ref().child(
                  'pastpapers_question_images/${uuid.v4()}${DateTime.now().microsecondsSinceEpoch.toString()}');
    ...
    showDialog(
      ...
      builder: (BuildContext context) => AlertDialog(
        ...
        content: Container(
          height: 180,
          child: Text(
            'Do you want to delete Past Paper : ${question.questionNumber}',
            style: TextStyle(
              fontFamily: 'Poppins',
        ...
        actions: <Widget>[
          ...
          TextButton(
            onPressed: () async {
              deletePastPaperFirebaseFunction(context, question);
              Navigator.of(context).pop();
            },
            child: const Text(
              "Delete",
